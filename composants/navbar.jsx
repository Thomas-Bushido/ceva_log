  ...
  return (
    <div>
      ...
      <div className={menu_class}>
       <div className="menu_class">
          <button className={button1} onClick={updateButtonMenu1}>Expéditions</button>
           ...
           <li className={button_menu1}>
            ...
            <li className={button_menu1}>
              <a className="links" href="http://localhost:3000/suivi_expeditions">Suivi</a>
            </li>
            <li className={button_menu1}>
          ...
          <button className={button2} onClick={updateButtonMenu2}>Clients</button>
            ...
            <li className={button_menu2}>
              <a className="links" href="#particularites">Particularités</a>
            </li>
            </ul>
          
          <button className={button3} onClick={updateButtonMenu3}>Messages</button>
            <ul className="optionsMenu">
